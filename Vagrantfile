...
Vagrant.configure("2") do |config|
  ...
  ##########
  config.vm.provision "shell", path: "https://raw.github.com/#{github_username}/#{github_repo}/#{github_branch}/scripts/oci.sh", privileged: false
  ...
  ##########
  #config.vm.provision "shell", path: "./oci.sh"
